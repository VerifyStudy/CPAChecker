...
public class SlicingAbstractionsRefiner implements Refiner, StatisticsProvider {
	...
	public SlicingAbstractionsRefiner(ARGBasedRefiner pRefiner, ARGCPA pCpa, LogManager pLogger) {
	...
	public static Refiner create(ConfigurableProgramAnalysis pCpa)
		...
		return new SlicingAbstractionsRefiner(refiner, argCpa, argCpa.getLogger());
	}
