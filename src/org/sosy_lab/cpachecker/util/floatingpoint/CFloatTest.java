...
public class CFloatTest {
  ...
  public void formatTest() {
    ...
    assertThat(cf_ld.toString()).isEqualTo("164347856758257.78125");
  ...
  public void nativeAdditionTest() {
    ...
    assertThat(a.add(b).toString()).isEqualTo(
        "7524684765169677983151898216552918432546148018107186116454526285746668082662221177263736538330443074074243977817790342874077938437724786562625620037057706141407809740727106950080390583826526714236202123264.0");
