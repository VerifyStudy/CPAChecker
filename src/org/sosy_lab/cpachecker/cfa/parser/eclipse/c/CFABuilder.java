 ...
 *
 * After instantiating this class, call
 * {@link #analyzeTranslationUnit(IASTTranslationUnit, String, Scope)} once for each translation
 * unit that should be used and finally call {@link #createCFA()}.
 */
class CFABuilder extends ASTVisitor {

  // Data structures for handling function declarations
  private final List<Triple<List<IASTFunctionDefinition>, String, GlobalScope>> functionDeclarations =
      new ArrayList<>();
  ...
  public void analyzeTranslationUnit(
    ...
    functionDeclarations
        .add(Triple.of(new ArrayList<IASTFunctionDefinition>(), staticVariablePrefix, fileScope));
  ...
  public int visit(IASTDeclaration declaration) {
    ...
    if (declaration instanceof IASTSimpleDeclaration) {
      ...
      throw parseContext.parseError(
          "Unknown declaration type " + declaration.getClass().getSimpleName(),
          declaration);
    }
  }
  ...
  private int handleSimpleDeclaration(final IASTSimpleDeclaration sd) {
    ...
    for (CAstNode astNode : sideAssignmentStack.getAndResetPreSideAssignments()) {
      if (astNode instanceof CComplexTypeDeclaration) {
        ...
        // We detect this case if the initializer of the temp variable is an initializer
        // list.
      ...
      if (newD instanceof CVariableDeclaration) {
        ...
        if (init != null) {
          ...
          if (!globalInitializedVariables.add(newD.getName())) {
            throw parseContext.parseError(
                "Variable " + newD.getName() + " initialized for the second time",
                newD);
          }
        }
