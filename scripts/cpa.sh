...
# java -XX:+PerfDisableSharedMem -Djava.awt.headless=true -Xss1024k -Xmx1200M -ea org.sosy_lab.cpachecker.cmdline.CPAMain -config ./config/default.properties ./doc/examples/example_bug.c
